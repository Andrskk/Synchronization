...
public class Network extends Thread {
    ...
    private static Semaphore emptySending;
    private static Semaphore fullReceiving;
    private static Semaphore fullTransferIn;
    private static Semaphore emptyTransferOut;
    ...
    Network( )
    {
        ...
        fullReceiving = new Semaphore(0);
        emptyTransferOut = new Semaphore(maxNbPackets);
        emptySending = new Semaphore(maxNbPackets);
